// Demo app. By default it uses the library source (:beacon). To check the *published* artifact
// instead, publish to Maven Local and build with -PuseMavenLocal:
//   ./gradlew :beacon:publishToMavenLocal :sample:assembleDebug -PuseMavenLocal
plugins {
...
android {
    namespace = "io.github.rajumark.hoverfly.beacon.sample"
    compileSdk = 36

    defaultConfig {
        applicationId = "io.github.rajumark.hoverfly.beacon.sample"
